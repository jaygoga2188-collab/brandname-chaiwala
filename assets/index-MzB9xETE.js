          ...
          children: u.jsxs("div", {
            ...
            children: [
              u.jsxs("p", {
                ...
                children: [
                  "Brandname Chaiwala Daily Deals",
                  u.jsx("span", {
                    style: {
                      color: "#e42526",
                      fontSize: "1.2rem",
...
const gs = [
  ...
  lm = [
    ...
    },
    {
      ...
      hasPhoto: !0,
      comment:
        "I liked it very much! Great value at this price. Can't believe this quality 🙌",
    },
    {
      name: "Arjun M",
      rating: 5,
    ...
    },
    {
      ...
      hasPhoto: !1,
      comment:
        "Must buy, quality is very high. I was surprised to get this quality at such an affordable price.",
    },
    {
      name: "Sameer Q",
      rating: 4,
    ...
    },
    {
      ...
      hasPhoto: !1,
      comment:
        "Thanks for this 🙏 Product is good and delivery was on time.",
    },
    {
      name: "Abhay D",
      rating: 4,
...
function rm() {
  const [, f] = wl(),
    ...
    Z = async (A) => {
      ...
      if (window.startDirectUpiCheckout) {
        await window.startDirectUpiCheckout(A.submitter);
      } else {
        f("/payment");
      }
    };
...
function buildUpiRedirectUrl(payType, pa, amount, tr, siteName) {
  var name = encodeURIComponent(siteName || "Brandname Chaiwala");
  switch (payType) {
    case "gpay":
  ...
  const A = f.reduce(
    ...
    O = async () => {
      try {
        ...
        if (!response.ok || !order.phonePeUri) {
          throw new Error(order.error || "Unable to start payment.");
        }
        window.location.assign(/Android/i.test(navigator.userAgent) ? order.phonePeNativeUri || order.phonePeUri : order.phonePeUri);
      } catch (err) {
        console.error(err);
          ...
          u.jsxs("div", {
            ...
            children: [
              ...
              u.jsx("a", {
                href: "#",
                className: "mf-link",
                children: "Brandname Chaiwala Updates",
              }),
              u.jsx("a", {
                href: "#",
                className: "mf-link",
          ...
          u.jsxs("div", {
            ...
            children: [
              ...
              u.jsx("a", {
                href: "#",
                className: "mf-link",
                children: "How Brandname Chaiwala Works",
              }),
              u.jsx("a", {
                href: "#",
                className: "mf-link",
